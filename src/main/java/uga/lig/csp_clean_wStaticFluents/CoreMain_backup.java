...
public class CoreMain_backup {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Future<HashMap<String, String>> foo = executor.submit(() -> {
      return callPlanner(directPath, selectedProblemfiles[selectedProblem], probN);
    });
    ...
    try {
      ...
      HashMap<String, String> statistic = foo.get();
    ...
    while (wait) {
    } // wait until timeout or success - we don't execute multiple problems in
      // parallel
    System.exit(1);
  ...
  public static HashMap<String, String> callPlanner(
      String directPath, String benchmarkName, int problemNumber) throws IOException {
     ...
     * benchmarkPath =
     * "C:/txdev-tx-annex/OptiPlan/pddlParser/app/src/main/resources/benchmarks/";
     * domainPath = benchmarkPath + "transport/domain.hddl";
     * problemPath = benchmarkPath + "transport/p01.hddl";
     */
    // CHILDSNACK
    ...
    // String domainPath =
    // "C:/txdev-tx-annex/OptiPlan/pddlParser/app/src/main/resources/benchmarks/bassetti_nontemporal/domain.hddl";
    // String problemPath =
    // "C:/txdev-tx-annex/OptiPlan/pddlParser/app/src/main/resources/benchmarks/bassetti_nontemporal/p04.hddl";
    // BASSETTI NONTEMPORAL
    // String domainPath =
    // "C:/txdev-tx-annex/OptiPlan/pddlParser/app/src/main/resources/benchmarks/bassetti_nontemporal/domain.hddl";
    // String problemPath =
    ...
    // OLD
    // String domainPath = "C:/txdev-tx-annex/OptiPlan/pddlParser -
    // 11-02-2022/app/src/main/resources/benchmarks/bassetti_javascript/domain.hddl";
    // String problemPath =
    // "C:/Users/oleksandr.firsov/Desktop/problem_gen.hddl"; DEMO String
    // domainPath = "C:/txdev-tx-annex/OptiPlan/pddlParser -
    // 11-02-2022/app/src/main/resources/benchmarks/bassetti_demo/domain.hddl";
    // String problemPath = "C:/txdev-tx-annex/OptiPlan/pddlParser -
    // 11-02-2022/app/src/main/resources/benchmarks/bassetti_demo/p02_gen.hddl";
      ...
      try {
        ...
        if (!errorManager.isEmpty()) {
          ...
          long encodingTimeCuml = durationSASTotal + durationDecomposeLayer + durationCellDomain +
              durationLayerFacts + durationRule1 + durationRule4 +
              durationRule5 + durationRule6 + durationRule8 + durationRule10 +
              durationRule11 + durationRule12 + durationRules13_15 +
              durationFileCopy;
          ...
          statistic.put("solveTime", (durationSolveTime / 1000000) + "ms");
  ...
  public static void logToExcel(List<HashMap<String, String>> benchmarkStat, String benchmarkName)
    ...
    String[] keys = { "totalTime", "pddl4j", "minizinc", "java", "solveTime", "durationSASTotal", "layerDecomposition",
